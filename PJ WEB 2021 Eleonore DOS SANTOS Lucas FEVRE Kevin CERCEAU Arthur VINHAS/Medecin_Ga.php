...
else
{
  ...
  echo   '<a class ="text-blue" href="DeconnexionClient.php?ref=Medecin_Ga.php">Deconnexion</a>';
  echo   '</div>';
  echo   '</li>';
      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <div class="row">
            ...
            $sql = "SELECT * from medecin where Specialisation = 'Gastro-Hepatho-Enterologue'";
