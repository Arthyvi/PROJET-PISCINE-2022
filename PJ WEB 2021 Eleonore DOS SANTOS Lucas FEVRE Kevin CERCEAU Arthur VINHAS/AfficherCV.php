...
?>
        ...
        <div style="background-color: white; width: 70%; margin-left:15%; margin-bottom:5%;">
            ...
            <h1 style="float:right;margin-right:10%; margin-top:4%;">Dr.<?php echo $Prenom?> <?php echo $Nom?> <br> <span style="font-size:large;"><?php echo $Specialisation?></span><br> <span style="font-size:large;">Mail : <?php echo "<A HREF='mailto:".$Mail."'>".$Mail."</A>"?></span><br> <span style="font-size:large;">Tel : +33<?php echo $Telephone?></span></h1>
