...
<!DOCTYPE html>
 ...
 <button onclick="window.location='Medecin_Personnel.php'" type="button" class="btn btn-secondary btn-sm" style=" margin-top: 1.3%; margin-left:12%; padding:1%; ">Retour</button>
