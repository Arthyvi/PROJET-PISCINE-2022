...
<body>
    ...
    <form class="main-form" id="SignInForm" action="inscription2.php" method="post">
        <table>
            <tr>
                <td>Nom : </td>
            ...
            <tr>
                ...
                <td><br><input class="form-control" type="text" name="id" id="id" required></td>
            </tr>
            <tr>
                <td>Mot de Passe : </td>
        ...
        <input type="submit" id="btnco" class="btn-sm btn-primary float-right" value="S'inscrire">
    </form></div>

    <a href="connexion.html"><div class="text-center" style="font-style:italic">Vous avez deja un compte?</div></a>
</div>
</div>
</body>
